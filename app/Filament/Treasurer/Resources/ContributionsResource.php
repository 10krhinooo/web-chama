...
use App\Filament\Treasurer\Resources\ContributionsResource\Pages;
use App\Filament\Treasurer\Resources\ContributionsResource\RelationManagers;
 ...
 public static function infolist(Infolist $infolist): Infolist
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewContributions::route('/{record}'),
