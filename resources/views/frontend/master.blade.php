            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="header-text"><br><br><br>
                  ...
                  <p>Our digital chama management system makes it easy to create, join, and manage chamas. Track finances, communicate with members, and collaborate efficiently. Join us today and simplify your chama activities.
        ...
        <div class="col-lg-6">
          <div class="service-item">
            ...
            <h4>Create a Chama</h4>
             <p>Start your own chama and invite members easily.</p>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="service-item">
            ...
            <p>Members have access to the group statement and can keep track of which administrator initiated, approved, and processed withdrawals. 
                This increases transparency and trust within the group which is necessary for growth.</p>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="service-item">
            ...
            <h4>Join a Chama</h4>
            <p>Join existing chamas with a special code.</p>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="service-item">
            ...
            <p>Track and manage your chama's finances with ease.</p>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="service-item">
            ...
            <h4>Communicate</h4>
            <p>Stay connected with your chama members through our platform.</p>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="service-item">
